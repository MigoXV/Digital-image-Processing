...
由于Fe(u)和Fo(u)都是4点的DFT，因此，如果对它们再按照奇偶进行分组， 则有
$$
\begin{aligned}
& \left\{\begin{array}{l}
...
表2-2 自然顺序与码位倒序（N=8） ![Picture 5](C:\Users\16955\Desktop\academiic\image\Picture 5.jpeg)        上述FFT是将f(x)序列按x的奇偶进行分组计算的，称之为时间抽选FFT。
